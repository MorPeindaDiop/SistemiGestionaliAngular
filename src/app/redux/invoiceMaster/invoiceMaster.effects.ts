...
import { createInvoiceMaster, deleteInvoiceMaster, initInvoicesMaster, retrieveAllInvoicesMaster } from './invoiceMaster.actions';
...
export class InvoicesMasterEffects {
    ...
    deleteInvoiceMaster(invoiceMaster: InvoiceMaster): Observable<Response> {
        return this.http.retrievePostCall<Response>("invoice/master/delete", invoiceMaster)
    }
    ...
    deleteInvoiceMaster$ = createEffect(() => this.actions$.pipe(
        ofType(deleteInvoiceMaster),
        switchMap(invoiceMaster => this.deleteInvoiceMaster(invoiceMaster.invoiceMaster).pipe(
            map(() => retrieveAllInvoicesMaster()),
        )))
    );
